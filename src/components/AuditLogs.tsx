                ...
                <>
                  ...
                  <div className="absolute left-0 top-full mt-2 bg-card border border-border rounded-xl shadow-xl z-50 p-4 min-w-[280px] animate-in fade-in slide-in-from-top-2">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-[10px] font-black text-muted-foreground uppercase mb-2">Tipo de Ação</label>
                        <select
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-[10px] font-black text-muted-foreground uppercase mb-2">Data Início</label>
                          <input
                            type="date"
                        ...
                        <div>
                          <label className="block text-[10px] font-black text-muted-foreground uppercase mb-2">Data Fim</label>
                          <input
                            type="date"
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex flex-col">
              <span className="text-primary-foreground/70 font-black text-xs uppercase tracking-widest">Backup Automático</span>
            ...
            <div className="flex flex-col">
              <span className="text-primary-foreground/70 font-black text-xs uppercase tracking-widest">Retenção de Dados</span>
